  ...
  return (
    <>
      <motion.button
        ...
        className="fixed right-3 top-[50%] z-30 flex h-9 w-9 translate-y-[calc(-50%+56px)] items-center justify-center rounded-full border border-border bg-card text-text-secondary shadow-lg transition-colors hover:bg-primary-light hover:text-primary md:bottom-8 md:left-8 md:right-auto md:top-auto md:translate-y-0 md:h-11 md:w-11"
