    ...
    <div className="flex flex-1 flex-col gap-6 px-4 py-6 pb-24 md:pb-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-text-secondary">
              Trusted people to alert during emergencies.
            </p>
          </div>
        </div>
        <Button
      ...
      {!isLoading && contacts.length === 0 && (
        ...
        >
          ...
          <div>
            <p className="text-lg font-semibold text-text-primary">No contacts yet</p>
            <p className="mt-1 text-sm text-text-secondary">
              Add trusted contacts to quickly share your location during emergencies.
            </p>
          </div>
          <Button size="md" icon={<Plus size={16} />} onClick={openAddForm} aria-label="Add first contact">
            Add Contact
          </Button>
        </motion.div>
      )}
              ...
              >
                <div className="group flex items-center gap-4 rounded-xl border border-border bg-card p-4 shadow-sm transition-all hover:border-primary/20 hover:shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {contact.relation && (
                      <span className="mt-1 inline-block rounded-md bg-secondary/10 px-2 py-0.5 text-[10px] font-medium text-secondary">
                        {contact.relation}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex shrink-0 gap-1 opacity-60 transition-opacity group-hover:opacity-100">
                    <a
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-xl bg-success/10 text-success transition-colors hover:bg-success/20"
                    ...
                    <button
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-xl bg-danger/10 text-danger transition-colors hover:bg-danger/20"
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={closeForm}
                  className="flex h-10 w-10 items-center justify-center rounded-xl text-text-secondary hover:bg-border/50"
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-5 flex flex-col gap-4">
                <div>
                  ...
                  <input
                    ...
                    {...register('name')}
                    className="h-11 w-full rounded-xl border border-border bg-background px-4 text-sm text-text-primary placeholder:text-text-secondary/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                  />
                  {errors.name && (
                ...
                <div>
                  <label htmlFor="contact-phone" className="mb-1.5 block text-xs font-medium text-text-secondary">
                    Phone *
                  </label>
                  <input
                    id="contact-phone"
                ...
                <div>
                  <label htmlFor="contact-relation" className="mb-1.5 block text-xs font-medium text-text-secondary">
                    Relation (optional)
                  </label>
                  <input
                    id="contact-relation"
                ...
                <div className="mt-2 flex gap-3">
                  ...
                  <Button
                    ...
                    className="flex-1"
                    aria-label={editingContact ? 'Save changes' : 'Add contact'}
                  >
